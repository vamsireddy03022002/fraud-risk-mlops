...
def main(config_path: str = "configs/train.yaml") -> None:
    ...
    # Load data (strict schema validation already applied)
    df_train = load_data(cfg["data"]["train_path"], cfg["data"]["schema_path"])
    df_valid = load_data(cfg["data"]["valid_path"], cfg["data"]["schema_path"])
